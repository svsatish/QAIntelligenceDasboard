...
const ComparisonView: React.FC<ComparisonViewProps> = ({ data }) => {
  ...
  return (
    <div className={`bg-white dark:bg-gray-800 ${compactView ? 'p-4' : 'p-6'} rounded-xl shadow-sm border border-gray-100 dark:border-gray-700 ${compactView ? 'mb-4' : 'mb-8'} transition-colors duration-200`}>
      <h3 className={`text-lg font-semibold text-gray-900 dark:text-white ${compactView ? 'mb-2' : 'mb-4'}`}>Cycle Comparison (Current vs Previous)</h3>
